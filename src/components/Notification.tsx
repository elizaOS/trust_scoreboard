...
const NotificationList = () => {
  ...
  return (
    <div
      className={`pointer-events-none fixed inset-20 z-20 flex items-end px-4 py-6 sm:p-6`}
    >
...
const Notification = ({ type, message, description, txid, onHide }) => {
  ...
  return (
    <div
      className={`bg-bkg-1 pointer-events-auto mx-4 mb-12 mt-2 w-full max-w-sm overflow-hidden rounded-md p-2 shadow-lg ring-1 ring-black ring-opacity-5`}
    >
      <div
        className={`rounded-md bg-gradient-to-r from-purple-900 from-10% via-purple-600 via-30% to-emerald-500 to-90% p-4`}
      >
